 ...
 * @param {{
 *   repository?: ReturnType<typeof createPopulationImportRepository>,
...
export function createPopulationImportService(pool, dependencies) {
  ...
  if (typeof acquireLock !== 'function') {
    throw new TypeError(
      'Population import acquireLock dependency is required',
    );
  }
  if (typeof recalculateStatistics !== 'function') {
    throw new TypeError(
      'Population import recalculateStatistics dependency is required',
    );
  }
