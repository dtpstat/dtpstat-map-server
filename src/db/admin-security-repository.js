...
const CREATE_USER_SQL = `
  INSERT INTO admin_users (
    ...
    can_manage_data, can_manage_interface, can_edit_geometries, can_edit_osm,
  ...
  return {
    ...
    async createUser(user) {
      const result = await database.query(CREATE_USER_SQL, [
        ...
        user.canManageData, user.canManageInterface, user.canEditGeometries, user.canEditOsm,
        user.canManageUsers, user.canViewAudit, user.canManageSecurity,
