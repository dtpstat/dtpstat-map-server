...
} from '../modules/geometry/import-policy.js';
...
async function applyStaged(client, sessionId, rawDecisions = []) {
  ...
  const decisions = normalizeGeometryImportDecisions(rawDecisions);
...
export function createGeometryImportStorage(database) {
  return {
