...
- настраиваемый рейтинг городов: колонки, расчётные метрики, агрегаты, группировки, арифметика и направление рейтинга;
...
Любое следующее изменение схемы должно быть новой миграцией V015+.
